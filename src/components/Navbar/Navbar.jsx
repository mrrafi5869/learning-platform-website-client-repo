  ...
  return (
    <div className={`Navbar ${theme}`}>
      <div className="navbar bg-base-100">
        ...
        <div className="flex mr-5 lg:flex-row md: flex-col">
